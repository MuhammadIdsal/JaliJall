...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[92;1m           JALI TUNNELING PREMIUM AUTO SCRIPT            \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
clear
if [ "${EUID}" -ne 0 ]; then
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/MuhammadIdsal/JaliJall/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/MuhammadIdsal/JaliJall/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/MuhammadIdsal/JaliJall/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/MuhammadIdsal/JaliJall/main/"
start=$(date +%s)
secs_to_human() {
...
print_install "Prosesing direktori xray"
mkdir -p /etc/xray
...
echo -e " Your OS Is Not Supported ( ${Green}$(cat /etc/os-release | grep -w PRETTY_NAME | head -n1 | sed 's/=//g' | sed 's/"//g' | sed 's/PRETTY_NAME//g')${FONT} )"
fi
}
...
clear
print_install "Instalasi Packet Script"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/MuhammadIdsal/JaliJall/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/MuhammadIdsal/JaliJall/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"Telegram","url":"https://t.me/Jalijall02"},{"text":"Whatsapp","url":"wa.me/6281585210167"}]]}'
curl -s --max-time $TIMES -d "chat_id=$CHATID&disable_web_page_preview=1&text=$TEXT&parse_mode=html" $URL >/dev/null
}
clear
function pasang_ssl() {
clear
print_install "Install SSL Pada Domain"
...
wget https://raw.githubusercontent.com/MuhammadIdsal/JaliJall/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
...
function ssh_slow(){
clear
print_install "Install SlowDNS Server"
...
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
print_install "Restart All Packet"
...
clear
echo ""
echo -e "\e[92;1m  Whatsapp : 081585210167 \e[0m"
echo -e "\e[92;1m  Telegram : @Jalijall02 \e[0m"
echo -e "\e[92;1m  Happy Surfing Best Script Tunneling  \e[0m"
echo ""
echo -e "\e[92;1m            ----[ INSTALL SUCCES ]----                   \e[0m"
echo -e "\e[92;1m          BANGJALI TUNNELING BY JALIJALL                     \e[0m"
echo -e ""
